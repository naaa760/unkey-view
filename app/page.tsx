    ...
    <div className="container relative min-h-screen flex-col items-center justify-between flex lg:flex-row lg:max-w-none lg:px-0">
      {apiKey.length > 0 && (
        <div className="absolute flex items-center right-4 top-4 md:right-8 md:top-8 gap-2 text-sm text-black">
          ...
          {apiKey}
          <button
            className="rounded-xl p-1.5 bg-gradient-to-r from-black to-blue-400 text-white active:scale-95"
      ...
      <div className="relative h-full flex-col flex p-10 text-white bg-gradient-to-r from-black to-blue-400 dark:border-r w-full lg:w-2/5 lg:min-h-screen">
        <Link
        ...
        <div className="mb-8 sm:mt-16">
          ...
          <p className="mt-2 text-base leading-6 sm:mt-6 lg:mt-12 text-white/80">
      ...
      <div className="lg:p-8 w-full lg:w-3/5 text-black bg-gradient-to-r from-blue-50 to-blue-100 border-l min-h-screen flex flex-col justify-center p-4">
        {isLoading ? null : apiKey.length < 1 ? (
          <div className="mx-auto flex w-full flex-col justify-center items-center space-y-6">
            <div className="flex flex-col space-y-3 text-center">
              ...
              <button
                ...
                className="rounded-md active:scale-95 bg-gradient-to-r from-black to-blue-300 text-white px-4 py-2 disabled:opacity-30 flex items-center justify-center"
              >
          ...
          <div className="flex flex-col items-center justify-center space-y-3">
            ...
            <div className="flex flex-col items-center">
              <div className="flex space-x-4">
                <button
                  ...
                  disabled={page <= 1}
                  className="rounded-md active:scale-95 bg-gradient-to-r from-black to-blue-300 text-white px-4 py-2 text-sm disabled:opacity-30 flex items-center justify-center"
                >
                ...
                <button
                  onClick={() => fetchPage(page + 1)}
                  className="rounded-md active:scale-95 bg-gradient-to-r from-black to-blue-400 text-white px-4 py-2 text-sm disabled:opacity-30 flex items-center justify-center"
                >
                  Next page
            ...
            {error.length > 0 && (
              <div className="py-2 px-4 rounded-md border border-red-700 bg-blue-300 flex items-center justify-center">
